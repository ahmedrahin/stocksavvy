...
@section('page-title')
    <title>Add Employee || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : '' }}</title>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="Experiance" placeholder="Experience" name="experience">
                                        </div>
                                    </div>
