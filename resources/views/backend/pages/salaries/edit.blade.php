...
@section('page-title')
    <title>Edit Supplier || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : '' }}</title>
@endsection
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- edit data --}}
                            <div id="edit-data">
                                <form action="{{route('update.supplier', $editData->id)}}" method="POST" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationName" placeholder="Supplier Name" value="{{$editData->name}}" name="name" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="holder" class="form-label">Account Holder</label>
                                                <input type="text" id="holder" placeholder="Account Holder" value="{{$editData->account_holder}}" name="holder">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select name="type" class="form-control select2" id="type" required>
                                                    <option value="">Select the supplier type</option>
                                                    <option value="Dropshippers" {{ ($editData->type == "Dropshippers") ? 'selected' : '' }} >Dropshippers</option>
                                                    <option value="Wholesalers" {{ ($editData->type == "Wholesalers") ? 'selected' : '' }} >Wholesalers</option>
                                                    <option value="Importers/Exporters" {{ ($editData->type == "Importers/Exporters") ? 'selected' : '' }}>Importers/Exporters</option>
                                                </select>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                           <div class="mb-3">
                                                <label for="salary" class="form-label">Supplier Picture</label>
                                                <div class="AppBody">
                                                    <div class="icon">
            ...
            $('.needs-validation').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#holder').val(response.editData.account_holder);
