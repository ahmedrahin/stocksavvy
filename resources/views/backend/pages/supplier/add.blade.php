...
@section('page-title')
    <title>Add Supplier || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : '' }} </title>
@endsection
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('store.supplier')}}" method="POST" class="needs-validation"  novalidate enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="validationName" class="form-label">Name</label>
                                            <input type="text" class="form-control" id="validationName" placeholder="Supplier Name" name="name" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="shop" placeholder="Account Holder" name="holder">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="bank" placeholder="Bank Account" name="bank_account">
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <button class="btn btn-primary" type="submit" id="addSupplier"> Add Supplier </button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            $('.needs-validation').submit(function(event) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, textStatus, errorThrown) {
                        ...
                        $("#addSupplier").prop('disabled', false).html('Add Supplier');
